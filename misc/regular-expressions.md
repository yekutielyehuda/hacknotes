...
Match all of these emails while also adding the username and the domain name \(not the TLD\) in separate groups \(use \w\): [hello@tryhackme.com](mailto:hello@tryhackme.com), [username@domain.com](mailto:username@domain.com), [dummy\_email@xyz.com](mailto:dummy_email@xyz.com)
